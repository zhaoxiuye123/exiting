...
def _build_example_one_file(filename, all_annotations):
    ...
    ann_key = filename.split('/')[-1][:-4]
    ann_key = ann_key.split('\\')[-1]
    ann_event_relations = list(filter(lambda x: x[0] == ann_key, all_annotations))
    pp = {'v': 5, 'b': 0, 'ii': 3, 'i': 2, 'a': 1, 's': 4}
    event_set = set([x[1] for x in ann_event_relations] + [x[2] for x in ann_event_relations])
    events = list(filter(lambda x: x[0] in event_set, events))
    ...
    for elem in ann_event_relations:
        ...
        if l.isdigit():
            if int(l) >= 5:
                event_relations[(elem[1], elem[2])] = 5
            else:
                event_relations[(elem[1], elem[2])] = int(l)
        else:
            event_relations[(elem[1], elem[2])] = pp[elem[-1]]
...
#
#     # ann_train_file = 'E:\\Desktop\\icjai\\EventTemp-main\\data\\TDDiscourse\\TDDAuto\\TDDAutoTrain.tsv'
#     # ann_dev_file = 'E:\\Desktop\\icjai\\EventTemp-main\\data\\TDDiscourse\\TDDAuto\\TDDAutoDev.tsv'
#     # ann_test_file = 'E:\\Desktop\\icjai\\EventTemp-main\\data\\TDDiscourse\\TDDAuto\\TDDAutoTest.tsv'
#
...
#     # print(len(ann_test))
#
#     train_files = glob.glob("E:\\Desktop\\icjai\\EventTemp-main\\data\\TimeBank-Dense\\train\\*")
#     dev_files = glob.glob("E:\\Desktop\\icjai\\EventTemp-main\\data\\TimeBank-Dense\\dev\\*")
#     test_files = glob.glob("E:\\Desktop\\icjai\\EventTemp-main\\data\\TimeBank-Dense\\test\\*")
#
#     train_examples = []
#     dev_examples = []
#     test_examples = []
...
#
#     # print("train_examples, dev_examples, test_examples", train_examples, dev_examples, test_examples)
#
#     return train_examples, dev_examples, test_examples

def build_all_example():
    # ann_train_dir = 'E:\\Desktop\\ijcai2\\EventTemp-main\\data\\Tbtrain.txt'
    # ann_dev_dir = 'E:\\Desktop\\ijcai2\\EventTemp-main\\data\\Tbdev.txt'
    # ann_test_dir = 'E:\\Desktop\\ijcai2\\EventTemp-main\\data\\Tbtest.txt'

    ann_train_dir = 'E:\\Desktop\ijcai2\\EventTemp-main\\data\\TDDiscourse\\TDDMan\\TDDManTrain_ed.tsv'
    ann_dev_dir = 'E:\\Desktop\ijcai2\\EventTemp-main\\data\\TDDiscourse\\TDDMan\\TDDManDev_ed.tsv'
    ann_test_dir = 'E:\\Desktop\ijcai2\\EventTemp-main\\data\\TDDiscourse\\TDDMan\\TDDManTest_ed.tsv'

    train_files_dir = "E:\\Desktop\\ijcai2\\EventTemp-main\\data\\TimeBank-dense\\train\\*"  # put raw document data here, both TBD and TDD use these raw documents
    dev_files_dir = "E:\\Desktop\\ijcai2\\EventTemp-main\\data\\TimeBank-Dense\\dev\\*"
    test_files_dir = "E:\\Desktop\\ijcai2\\EventTemp-main\\data\\TimeBank-Dense\\test\\*"

    ann_train_file = ann_train_dir  # put annotation data dir here
    ann_dev_file = ann_dev_dir
    ann_test_file = ann_test_dir
    ...
    train_files = glob.glob(train_files_dir)
    dev_files = glob.glob(dev_files_dir)
    test_files = glob.glob(test_files_dir)
...
def generate_examples():
    ...
    # print("build_all_example", train_examples)
    ...
    # print("_slide_window",train_examples)
    ...
    # print("train_examples, add_negative_examples", train_examples)
